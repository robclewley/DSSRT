...
% ( minor adjustments by Rob Clewley Jan 04 -- search for 'RHC:' )
%
...
FigWidth=160;FigHeight=50; % RHC: FigWidth was 190
if isempty(gcbf)
    ...
    FigPos(1)=1/3.5*(ScreenSize(3)-FigWidth); % RHC: was 1/2
    FigPos(2)=1/2*(ScreenSize(4)-FigHeight); % RHC: was 2/3
else
...
[WrapString,NewMsgTxtPos]=textwrap(MsgHandle,Question,65); % RHC: was ,75
