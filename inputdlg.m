...
%%% Create InputFig %%%
%%%%%%%%%%%%%%%%%%%%%%%
FigWidth=160;FigHeight=100; % RHC: FigWidth was 300
...
for ExtLp=1:NumQuest,
  if size(NumLines,2)==2
    ...
    [WrapQuest{ExtLp},QuestPos(ExtLp,1:4)]= ...
        textwrap(ExtControl,Prompt(ExtLp),40); % RHC: was "textwrap(ExtControl,Prompt(ExtLp),80)"
  end
end % for ExtLp
...
FigPos(1)=(ScreenSize(3)-FigWidth)/3.5; % RHC: was /2
